...
import { Language, SOSAlert, UserProfile } from '../types';
  ...
  const handleTriggerSOS = () => {
    ...
    setTimeout(() => {
      const newAlert: SOSAlert = {
        ...
        status: 'assigned',
        responderInfo: {
          mr: 'वैद्यकीय पथक २ व १०८ रुग्णवाहिका (मार्गस्थ - ३ मिनिटे अंतर)',
          hi: 'चिकित्सा टीम २ और १०८ एम्बुलेंस (मार्ग में - ३ मिनट की दूरी)',
          en: 'Medical Team 2 & 108 Ambulance (Dispatched - 3 mins away)',
        }
      };
              ...
              >
                <div>
                  ...
                  <p className="text-xs font-bold text-emerald-800 mt-1 bg-emerald-50 p-2 rounded-lg border border-emerald-200">
                    🚑 {typeof sos.responderInfo === 'object' ? sos.responderInfo[language] : sos.responderInfo}
                  </p>
                </div>
